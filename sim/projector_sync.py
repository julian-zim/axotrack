...
class ParameterControl(QWidget):	
	...
	def __init__(self, camera):
		...
		self.max_dim = min(1544, 1544)  # force square max image
		init_width = 1544
		init_height = 1544
		init_offsetx = 520
		init_offsety = 0
		...
		self.slider_offsetx.setMaximum(2064 - init_width)
		...
		self.edit_offsetx.setValidator(MultiplesValidator(4, 0, 2064 - init_width))
...
def main2():
	...
	controller = ParameterControl(None)
	controller.show()
